"""
Forward Kinematics Simulation for differential drive robot.
Similar to the C++ version but using Python and helper_py library.
"""
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Forward Kinematics Simulation - Python (Joysticks or W/S/A/D | R - Reset | ↑↓/PgUp/PgDn - Zoom)")
